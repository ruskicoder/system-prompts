# install-cursor.ps1 - Cursor Rules Installer
...
Write-Host " Cursor Rules Target Deployment                    " -ForegroundColor Cyan
Write-Host "====================================================" -ForegroundColor Cyan
...
Write-Host "`n[SUCCESS] Cursor Rules deployment complete.`n" -ForegroundColor Green
Exit 0
